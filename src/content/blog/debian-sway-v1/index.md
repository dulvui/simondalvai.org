...
I didn't find much on the web about how to setup and use Sway on Debian, therefor I will share my experience here.
...
So you can for example change your Sway key binds at home, and the next day at work, get the changes instantly synced to your working machine.
I currently use a git and [Syncthing](https://syncthing.net/) combination to backup and synchronize my most precious files.
Even on my Android phone with Neovim on Termux, I could reuse my Neovim configuration.  
...
Therefore a lot of guides will not work yet.
...
An older and less feature rich alternative can be [screen](https://savannah.gnu.org/projects/screen).
...
Personally I use thew built-in sway-bar, but many prefer and use the more feature packed [Waybar](https://github.com/Alexays/Waybar).
...
So you can for example also **disable the laptop's display** while attached to other monitors.
...
Neverless, when reloading the Sway config with **Ctrl + c**, it's fixed 9 out of 10 times.

### More tools...
Here some more tools I'm currently using, but explaining every single one would make this blog post more a book.  
...
- [**slurp**](https://github.com/emersion/slurp/releases) and [**grimshot**](https://packages.debian.org/bookworm/grimshot) - taking screenshots
...
- [**light**](https://packages.debian.org/bookworm/light) - to change display brightness
...
I like having my user **not in the sudoers group**, like the default Debian installation has.
...
I will try my best and list what I have installed, to fix the issue.
```bash
# audio
...
For that, it could be that yours work out of the box, or need another library to work.

### Start Sway on login
Simply put the following lines to your **~/.profile** file, and Sway will automatically start, once you logged in.
